...
st.set_page_config(
    page_title="Real-time RAG with Kestra", page_icon="./app/static/favicon.ico"
)

with st.sidebar:
    st.markdown("**Start building real-time data products with [Kestra](https://kestra.io).**")
...
st.write("## Ask queries regarding product reviews")

st.image('kestra_logo.jpeg', caption='Powered By Kestra')
